...
public enum ErrorCode {
    ...
    // 404
    SHOP_NOT_FOUND_EXCEPTION(HttpStatus.NOT_FOUND, "해당 매장 정보가 없습니다. postId = ", "NOT_FOUND_404" ),
    CUSTOMER_NOT_FOUND_EXCEPTION(HttpStatus.NOT_FOUND, "해당 사용자가 없습니다. customerId = ", "NOT_FOUND_404"),
