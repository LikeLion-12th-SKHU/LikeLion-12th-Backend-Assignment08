...
public enum ErrorCode {
    ...
    MAJOR_NOT_FOUND_EXCEPTION(HttpStatus.NOT_FOUND, "해당 전공이 없습니다. majorId = ", "NOT_FOUND_404"),
    STUDENT_NOT_FOUND_EXCEPTION(HttpStatus.NOT_FOUND, "해당 전공이 없습니다. studentId = ", "NOT_FOUND_404"),
