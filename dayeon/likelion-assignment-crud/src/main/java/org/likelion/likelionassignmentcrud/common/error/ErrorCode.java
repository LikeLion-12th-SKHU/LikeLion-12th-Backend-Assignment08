...
public enum ErrorCode {
     ...
     * 404 NOT_FOUND
     */
    ORDERS_NOT_FOUND_EXCEPTION(HttpStatus.NOT_FOUND, "해당 발주내역이 없습니다. orderId = ", "NOT_FOUND_404"),
    MEMBERS_NOT_FOUND_EXCEPTION(HttpStatus.NOT_FOUND, "해당 사업자가 없습니다. memberId = ", "NOT_FOUND_404"),
