...
public enum ErrorCode {
     ...
     */
    // 400대는 요청 에러
    ORDERS_NOT_FOUND_EXCEPTION(HttpStatus.NOT_FOUND, "해당 주문이 없습니다. ordersId = ", "NOT_FOUND_404"),
    USERS_NOT_FOUND_EXCEPTION(HttpStatus.NOT_FOUND, "해당 고객이 없습니다. usersId = ", "NOT_FOUND_404"),
