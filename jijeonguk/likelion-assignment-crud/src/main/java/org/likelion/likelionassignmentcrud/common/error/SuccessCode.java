...
public enum SuccessCode {
    ...
    USERS_UPDATE_SUCCESS(HttpStatus.OK, "고객이 성공적으로 수정되었습니다."),
    ORDERS_DELETE_SUCCESS(HttpStatus.OK, "주문이 성공적으로 삭제되었습니다."),
    USERS_DELETE_SUCCESS(HttpStatus.OK, "고객이 성공적으로 삭제되었습니다."),

    /**
     * 201 CREATED
     */
    ORDERS_SAVE_SUCCESS(HttpStatus.CREATED, "주문이 성공적으로 등록되었습니다."),
    USERS_SAVE_SUCCESS(HttpStatus.CREATED, "고객이 성공적으로 등록되었습니다.");
