...
public enum ErrorCode {
     ...
     * 404 NOT FOUND
     */
    GAMES_NOT_FOUND_EXCEPTION(HttpStatus.NOT_FOUND, "해당 게임이 없습니다. gameId = ", "NOT_FOUND_404"),
    DEVELOPERS_NOT_FOUND_EXCEPTION(HttpStatus.NOT_FOUND, "해당 개발사가 없습니다. developerId = ", "NOT_FOUND_404"),
