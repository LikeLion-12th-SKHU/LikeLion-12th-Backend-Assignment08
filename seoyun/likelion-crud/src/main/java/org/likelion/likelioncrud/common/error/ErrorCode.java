...
public enum ErrorCode {
     ...
     */
    ORDERS_NOT_FOUND_EXCEPTION(HttpStatus.NOT_FOUND, "해당 주문이 없습니다. orderId = ", "NOT_FOUND_404"),
    CONSUMERS_NOT_FOUND_EXCEPTION(HttpStatus.NOT_FOUND, "해당 고객이 없습니다. consumerId = ", "NOT_FOUND_404"),
